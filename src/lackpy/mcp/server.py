...
async def delegate(intent: str, kit: str | list[str] | dict | None = None,
    ...
    return await _get_service().delegate(intent, kit=kit, params=params, sandbox=sandbox, rules=rules, extra_tools=extra_tools)
...
async def generate(intent: str, kit: str | list[str] | dict | None = None,
    ...
    result = await _get_service().generate(intent, kit=kit, params=params, rules=rules, extra_tools=extra_tools)
...
async def run_program(program: str, kit: str | list[str] | dict | None = None,
    ...
    result = await _get_service().run_program(program, kit=kit, params=params, sandbox=sandbox, rules=rules, extra_tools=extra_tools)
...
async def create(program: str, kit: str | list[str] | dict | None = None,
    ...
    return await _get_service().create(program, kit=kit, name=name, pattern=pattern, extra_tools=extra_tools)
...
def validate(program: str, kit: str | list[str] | dict | None = None,
    ...
    result = _get_service().validate(program, kit=kit, rules=rules, extra_tools=extra_tools)
    return {"valid": result.valid, "errors": result.errors, "calls": result.calls, "variables": result.variables}


@mcp.tool()
def kit_info(kit: str | list[str] | dict, extra_tools: list[str] | None = None) -> dict:
    """Get info about a kit: tools, grades, descriptions."""
    return _get_service().kit_info(kit, extra_tools=extra_tools)
...
@mcp.tool()
def docs_index(kit: str | list[str] | dict | None = None,
               extra_tools: list[str] | None = None) -> dict:
    """Return documentation references for a kit's tools and kit-level docs."""
    return _get_service().docs_index(kit=kit, extra_tools=extra_tools)
